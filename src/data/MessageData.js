const MessageData = {
    ...
    "work": [
        "I am currently a casual academic at the University of Queensland.",
        "The course I tutor teaches students about working in large teams, with a focus on version control tools, build tools, testing, design patterns and communication tools (UML diagrams, Kanban boards, etc)",
    ...
    "projects": [
        ...
        "Online Therapy Site - Mock website/forum for parents with children experiencing mental health issues to book virtual appointments with specialists, and to seek advice from other parents.",
